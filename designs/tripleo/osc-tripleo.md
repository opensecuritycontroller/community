...
description: >
 ...
 parameters:
  #  The paramater EndpointMap is required for all service templates*.
  EndpointMap:
    default: {}
...
outputs:
  # Service templates must output a role_data value containing the config_settings and step_config for the service configuration**
  role_data:
...
TODO: Replace placeholder with actual environment variable Srequired by OSC.  
...
#### OSC TLS & Secrete Data Configuration  
